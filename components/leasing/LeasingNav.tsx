...
/* ─────────────────────────────────────────────
   Minimal, premium top nav for the /leasing surface.
   Fixed glass pill with:
   - Logo → /
   - "Paths" pill group (4 categories) visible only from a category page
   - Inquire CTA
───────────────────────────────────────────── */

export default function LeasingNav() {
    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <span style={{ color: "rgba(201,169,110,0.80)" }}>Leasing</span>
        </div>
